...
public class PruebaVJ {
    public static void main(String[] args) {
        ...
        PilaMaterialesGen<Integer> PM = new PilaMaterialesGen<>();
        PilaMaterialesGen<Integer> PR = new PilaMaterialesGen<>();
        PilaMaterialesGen<Integer> PH = new PilaMaterialesGen<>(); 
